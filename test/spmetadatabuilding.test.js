...
beforeAll(() => {
    ...
    requestedAttributes = [
        ...
        { key: 'familyName', samlName: 'familyName' },
        { key: 'fiscalNumber', samlName: 'fiscalNumber' },
        { key: 'email', samlName: 'email' }
    ]
});

test('Can render an sp metadata with ejs', () => {
        let spmetadata = ejs.render(template, {idps: dataToMerge, common, requestedAttributes});
